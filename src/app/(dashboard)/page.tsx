  ...
  return (
    <div className="p-10 max-w-7xl mx-auto space-y-12">
      ...
      <header className="flex items-end justify-between">
        <div>
          <h2 className="text-4xl font-bold tracking-tight text-white mb-2">Resumen General</h2>
          <p className="text-nordic-on-bg/60">Bienvenido de nuevo al panel editorial de Nordic.</p>
        </div>
        <div className="flex items-center gap-4">
          <div className="relative group">
            ...
            <input 
              type="text" 
              placeholder="Buscar..." 
              className="bg-nordic-surface-high text-sm pl-10 pr-4 py-2.5 rounded-xl border border-nordic-outline-variant/10 focus:outline-none focus:border-nordic-primary/40 transition-all w-64"
            />
          </div>
